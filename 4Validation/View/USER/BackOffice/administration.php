...
//require_once 'pdo_connection.php'; // Assure-toi que la connexion PDO est bien incluse ici
...
if (isset($_GET['action']) && $_GET['action'] === 'delete') {
    ...
    if (deleteUser($pdo, $userId)) {
        ...
        // Facultatif : déconnexion si l'utilisateur se supprime lui-même
        session_destroy();
        header("Location: login_register.php");
        exit;
    } else {
   ...
   <div class="container">
    ...
    <aside> 
      ...
      <div class="sidebar">
        ...
        <a href="http://localhost/4Validation/View/USER/BackOffice/administration.php" class="active">
    ...
    <main>
      ...
      <div class="administration-grid">
        <div class="administration-card users">
          ...
          <h3>Utilisateurs</h3>
          <p><?= count($users) ?> utilisateurs actifs</p>
        </div>
      ...
      <div class="user-management">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
          <h2>List of users</h2>
          <a href="../../Controllers/export_pdf.php" class="export-btn">Export PDF</a>
        </div>
          ...
          <table id="usersTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <form method="POST" action="../../../Controller/USER/userscontrollers.php?action=update_admin">
                ...
                <td>
<a href="administration.php?action=delete&id=<?= htmlspecialchars($user->getId()) ?>" onclick="return confirm('Supprimer cet utilisateur ?');">Supprimer</a>
...
<div class="profile">
   <div class="info">
       <p><b><?= htmlspecialchars($user->getNom()) ?></b></p>
       <p>Admin</p>
       <small class="text-muted"></small>
   </div>
   <div class="profile-photo">
     <img src="<?= !empty($user->getFaceImagePath()) ? htmlspecialchars($user->getFaceImagePath()) : 'images/default-profile.jpg' ?>" alt=""/>
   </div>
</div>
