...
<head>
    ...
    <style>
        ...
        .header {
  display: flex;           /* logo + titre côte-à-côte */
  align-items: center;     /* alignement vertical */
  gap: 0.5rem;             /* petit espace entre logo et texte */
}

.logo {
  height: 50px;            /* ou la hauteur que vous préférez */
  width: auto;             /* pour garder la proportion */
}
...
<div class="header">
  <<div class="header">
  <img src="<?= realpath(__DIR__ . '/../Frontoffice/logo.png') ?>" class="logo" alt="NEXT STEP">
  <h1 class="title">NEXT STEP</h1>
</div>

<h2 class="subtitle">Rapport des Investissements</h2>
