          ...
          <?php
              ...
              <?php foreach ($paginatedEvents as $event): ?>
                ...
                <div class="event-card">
                    <?php
                    $defaultImage = '/4Validation/uploads/events/default-event.jpg';
...
<script>
  function openModal(eventData) {
    // Affichage basique dans un alert pour test
    alert("Événement : " + eventData.title + "\nDate : " + eventData.date + "\nLieu : " + eventData.location + "\nDescription : " + eventData.description);

    // Exemple plus avancé : remplir un modal existant
    ...
    if (modal) {
        ...
        document.getElementById("modalLieu").textContent = eventData.location;
