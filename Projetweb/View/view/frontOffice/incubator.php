...
<body>
  ...
  <section id="nitro-section" class="py-12 px-4 bg-gray-100">
    <div class="rocket" style="float: left;">
      <img src="image/rocket.png" alt="beginner" width="400">
    </div>
    <br><br><br>
    <div class="flex flex-wrap justify-center gap-8">
      <?php foreach($nitroPlans as $plan): ?>
        <div class="plan start">
          <div class="icon">
            <img src="image/beginner.png" alt="Plan Icon" width="30">
          </div>
          <div class="title"><?= htmlspecialchars($plan['nitro_name']) ?></div>
          <ul class="features">
            <li>Period: <?= htmlspecialchars($plan['nitro_period']) ?></li>
          </ul>
          <button class="pricing nitro-btn" data-id="<?= $plan['id_nitro'] ?>"><?= htmlspecialchars($plan['nitro_price']) ?> TND<sup></sup></button>
        </div>
      <?php endforeach; ?>
    </div>
  </section>
  ...
  <div class="workshop" style="float: left;">
    <img src="image/workshop.png" alt="beginner" width="400" style="margin-top: 20%;"></div>

  <section id="workspace-section" class="py-12 px-4 bg-white">
    ...
    <p class="text-center max-w-2xl mx-auto mb-8 text-gray-600">
      Access collaborative office environments equipped with high-speed internet, meeting rooms, and creative zones to boost your productivity and connect with fellow innovators.
    </p>
  ...
  <!-- Workshop Section -->
  <center>
  <section id="workshop-section" class="py-12 px-4 bg-gray-50">
    <h2 class="text-3xl font-bold text-center text-gray-800 mb-6">Workshops</h2>
    <p class="text-center max-w-2xl mx-auto mb-8 text-gray-600">
      Participate in our educational workshops to gain new skills and knowledge from industry experts.
    </p>
...
participateButtons.forEach(function(button) {
  button.addEventListener("click", function() {
    ...
    // Generate a unique registration ID (you might want to use server-side ID in real implementation)
