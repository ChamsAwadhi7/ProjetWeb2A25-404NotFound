...
try {
    ...
    // Incrémenter les vues si "Commencer" est cliqué
...
<body>
    ////////////
<input type="hidden" id="courseId" value="<?= (int)$id ?>">
    ///////////
...
<div class="container">
    ...
    <div class="content">
        ...
        <form method="post" style="margin-top: 30px;">
            ...
            <button type="submit" name="commencer" class="btn" onclick="commencerCours(<?= (int)$course['id']; ?>, <?= (float)$course['Prix']; ?>)">Acheter et Commencer</button>
        </form>
...
<?php if ($accesAutorise && !empty($chapitres)): ?>
    <div class="chapitres">
        ...
        <?php foreach ($chapitres as $chapitre): ?>
            <div class="chapitre">
                <label>
                    <input type="checkbox" class="check-chapitre">
                    <span class="check-icon">&#10003;</span>
                    <?= htmlspecialchars($chapitre['nomChapitre']) ?> 
                    (<?= htmlspecialchars($chapitre['typeContenu']) ?>)
                </label>
...
<?php else: ?>
    <p style="color: red;">⛔ Accès refusé. Vous devez acheter ce cours pour voir son contenu.</p>
<?php endif; ?>
