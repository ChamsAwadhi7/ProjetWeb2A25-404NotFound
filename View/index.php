    ...
    <nav class="navbar">
      ...
      <ul class="nav-links">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a href="STARTUP/FrontOffice/startup.php"><i class="fas fa-cogs"></i>Startup</a>
            </li>
          </ul>
        </li>
        <li class="dropdown">
      ...
      <div class="search-box">
        ...
        <a href="profile.php" class="profile-button" title="Mon profil">
         <i class="fas fa-user"></i>
        </a>

        <a href="logout.php"><button class="login-btn"><i class="fas fa-user"></i> logout</button></a>
