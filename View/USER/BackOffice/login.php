...
<head>
  ...
  <style>
    /* Ton CSS existant… */
    body { margin:0; padding:0; font-family:"Segoe UI"; background:url('../../assets/images/background.jpg') center/cover fixed; display:flex; align-items:center; justify-content:center; height:100vh; }
...
<body>
  ...
  <form class="login-container" action="../../Controllers/login_admin.php" method="post">
  ...
  <div id="resetModal" class="modal">
    <div class="modal-content">
      ...
      <?php endif; ?>
      <form action="../../Controllers/reset_password_request.php" method="post">
